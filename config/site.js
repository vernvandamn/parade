module.exports = {
  ...
  logo: 'static/logo/gd_facebook.png', // Used for SEO
  banner: 'static/logo/GDMS-white.png',
  // JSONLD / Manifest
  favicon: 'static/logo/gd_facebook.png', // Used for manifest favicon generation
